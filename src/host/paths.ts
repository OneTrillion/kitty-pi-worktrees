...
export const worktreeDirectoryName = (branch: string): string => {
...
export const deriveWorktreePath = (trustedRoot: string, branch: string): string => {
...
export const worktreeId = (canonicalPath: string): string => {
